...
// ── STOCKFISH WORKER ──────────────────────────────────────────
//  Stockfish 11 pure asm.js — WASM bağımlılığı yok.
//  jsDelivr CDN → fetch → Blob Worker.
//  Repoya dosya yüklemeye gerek yok.

const SF_URL = 'https://cdn.jsdelivr.net/gh/nmrugg/stockfish.js@Stockfish11/src/stockfish.js';
...
function initStockfish() {
  ...
  fetch(SF_URL)
    ...
    .catch(err => {
      engineFailed('CDN fetch hatası: ' + err.message);
    });
}
